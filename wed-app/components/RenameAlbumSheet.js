// components/RenameAlbumSheet.js
// ✅ Same fix as NewAlbumSheet (backspace + typing stable)
// ✅ NEW: Close icon uses close.png (assets)
...
export default function RenameAlbumSheet({
  visible,
  onClose,
  value,
  onChangeText,
 ...
 emojiSvg: EmojiSvg = FolderIcon,
        ...
        <View style={[styles.bottomDock, { bottom: dockBottom, zIndex: 2, elevation: 2 }]} pointerEvents="box-none">
          ...
          >
            <View style={[styles.miniHeader, { borderBottomColor: cBorder }]}>
              <Text style={[styles.miniTitle, { color: cText }]}>Rename</Text>
  ...
  <EmojiSvg width={30} height={30} />
            ...
            >
              <Text style={styles.miniPrimaryText}>SAVE</Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
